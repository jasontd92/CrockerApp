...
public class DeviceControlActivity extends Activity {
    ...
    //jasontd In DeviceControlActivity add a class member to save a reference to the
    ...
    /*jasontd This function should be very similar to the displayGattServices() function,
    minus anything to do with building the list UI. It will loop through the services and
    characteristics to find the characteristics matching the UUID.
     */
    private void findGattServices(List<BluetoothGattService> gattServices, UUID uuid) {
        if (gattServices == null) return;
        String unknownServiceString = getResources().getString(R.string.unknown_service);
        String unknownCharaString = getResources().getString(R.string.unknown_characteristic);
        ArrayList<HashMap<String, String>> gattServiceData = new ArrayList<HashMap<String, String>>();
